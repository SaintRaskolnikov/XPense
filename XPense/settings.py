...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'XPense.context_processors.user_info',
                'XPense.context_processors.translation_context_processor',
            ],
        },
    },
]
...
FIELD_ENCRYPTION_KEY = b'a89YPf5XiGXhklL6ojs4ShtK8bbpJGngcCNgwectagw='
